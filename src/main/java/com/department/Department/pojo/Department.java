package com.department.Department.pojo;
...
public class Department {
	 ...
	 * departmentCode; } public Department(Long departmentId, String departmentName,
	 * String departmentAddress, String departmentCode) { super(); this.departmentId
	 * = departmentId; this.departmentName = departmentName; this.departmentAddress
	 * = departmentAddress; this.departmentCode = departmentCode; }
	 * 
